  ...
  return {
    ...
    addAirplane: async (data) => {
      ...
      const result = await pool.query(
        ...
        [registration_number, model, manufacturer, capacity || 180, status || 'Active', manufacture_year]
      );
    ...
    updateAirplane: async (id, data) => {
      ...
      const result = await pool.query(
        ...
        [registration_number, model, manufacturer, capacity || 180, status || 'Active', manufacture_year, id]
      );
